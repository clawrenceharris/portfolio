...
export const projects = [
  ...
  },
  {
    ...
    additionalImages: [
      require("../assets/images/projects/13.png"),
      require("../assets/images/projects/14.png"),
    ],
    tryItLink: "https://clawrenceharris.github.io/desk/",
    images: [require("../assets/images/projects/14.png")],
    tags: ["Web", "UI/UX"],
...

  {
    ...
    longDescription: [
      "Gomi Hero is a puzzle platformer game I made with a partner during a Hackathon, where the player can change into trash bins of various colors. The game's mechanics aims to teach players about proper sorting of trash and its importance to environmental sustainability while inspiring others to make an environmental impact.",
      "As both of us had no prior experience with Flutter or Dart, embarking on this project presented a significant challenge. Learning the language and familiarizing ourselves with the APIs became a steep learning curve. Developing an effective collision detection system and crafting the UI using Flutter's widgets posed yet another challenge that, with careful attention to detail, we successfully overcame.",
      "As I took charge of the UI and game logic, this project allowed me to demonstrate my proficiency in Flutter as well as programming architecture and design.",
    ],
